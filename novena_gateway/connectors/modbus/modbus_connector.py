...
from novena_gateway.connectors.modbus.constants import ADDRESS_PARAMETER, TAG_PARAMETER, \
    FUNCTION_CODE_PARAMETER
from novena_gateway.connectors.modbus.entities.rpc_request import RPCRequest, RPCType
...
from novena_gateway.connectors.connector import Connector
from novena_gateway.gateway.constants import STATISTIC_MESSAGE_RECEIVED_PARAMETER, \
...
from novena_gateway.tb_utility.tb_logger import init_logger

# Verify Pymodbus library is available (installed via requirements.txt)
try:
    ...
    raise ImportError(
        "Modbus dependencies not installed. Run: pip install pymodbus pyserial pyserial-asyncio"
    ) from e

from novena_gateway.connectors.modbus.utils import Utils  # noqa: E402
from novena_gateway.connectors.modbus.entities.master import Master  # noqa: E402
from novena_gateway.connectors.modbus.server import Server  # noqa: E402
from novena_gateway.connectors.modbus.slave import Slave  # noqa: E402
from novena_gateway.connectors.modbus.entities.bytes_downlink_converter_config import \
    BytesDownlinkConverterConfig  # noqa: E402
from novena_gateway.connectors.modbus.backward_compatibility_adapter import BackwardCompatibilityAdapter  # noqa
...
class AsyncModbusConnector(Connector, Thread):
    ...
    def __wait_task_with_timeout(self, task: asyncio.Task, timeout: float, poll_interval: float = 0.2):  # noqa
        start_time = monotonic()
